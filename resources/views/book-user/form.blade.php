<div class="box box-info padding-1">
    ...
    <br>
        ...
        <br>
        <div class="form-group">
            {{ Form::label('status', 'Estado del Libro') }}
            {{ Form::select('status', ['Disponible' => 'Disponible', 'No Disponible' => 'No Disponible'], $bookUser->book->status, ['class' => 'form-control' . ($errors->has('status') ? '                         is-invalid' : ''), 'placeholder' => 'Selecciona un estado']) }}
